// Script para testeo completo con 100 pilotos
// Uso: node src/scripts/testWith100Drivers.js
// Crea usuarios de prueba y les da votos aleatorios a los 100 pilotos
...
const NUM_USERS = 50; // 50 usuarios de prueba
const MAX_VOTES = 10;
...
async function showTestStatistics() {
  console.log('\n📊 Estadísticas del testeo con 100 pilotos:');
...
async function main() {
  console.log('🚀 Iniciando testeo completo con 100 pilotos...');
